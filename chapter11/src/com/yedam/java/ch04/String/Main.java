...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * byte[] byte2 = new byte[100]; System.out.println("입력 >>"); // 배열에 읽은 바이트를
		 * 저장하고 읽은 바이트 수를 리턴 int readByteNo = System.in.read(byte2);
		 * 
		...
		System.out.println("bytesX.lengh : " + bytesX.length);
		...
		try {
			...
			String strZ = new String(byteY, "EUC-KR");
			System.out.println("byteZ -> strY : " + strZ);
		...
		if(subject.indexOf("한국") != -1) {
			System.out.println("한국과 관련된 책이군요.");
		} else {
			System.out.println("한국과 관련이 없는 책이군요.");
		}
