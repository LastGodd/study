...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * // 일반고객 : 이순신, 10010, 1000점 Customer customerLee = new Customer();
		 * customerLee.setCustomerName("이순신"); customerLee.setCustomerId(10010);
		 * customerLee.bonusPoint = 1000;
		 * System.out.println(customerLee.showCustomerInfo()); System.out.println();
		 * 
		 * // VIP : 김유신, 10020, 10000점 VIP customerKim = new VIP();
		 * customerKim.setCustomerName("김유신"); customerKim.setCustomerId(10020);
		 * customerKim.bonusPoint = 10000;
		 * System.out.println(customerKim.showCustomerInfo()); System.out.println();
		 */
		...
		customerList[4] = new VIP("김유신", 10050, 12345);
