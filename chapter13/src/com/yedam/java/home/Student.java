...
public class Student {
	...
	private List<Subject> subjectList; // 수강과목 목록
	...
	public void showStudentInfo() {
		 ...
		 * subjectList[i].getName(), subjectList[i].getScorePoint()); } // 학생의 총점을 계산해서
		 * 출력하세요. // 출력형태 : 학생 홍길동의 총점은 300점입니다. int sum = 0; for (int i = 0; i <
		 * subjectIndex; i++) { sum += subjectList[i].getScorePoint(); }
